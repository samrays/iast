"""Convert Appendices Markdown document into a beautifully formatted Word Document (.docx)."""
...
def add_formatted_paragraph(doc, text, style='Normal', space_after=6, space_before=0, bold=False, italic=False, font_size=11, color_rgb=(50, 50, 50)):
    ...
    # Inline formatting parser for **bold** and *italic* and `code` and $math$
        ...
        for r_idx, row in enumerate(rows_data):
            ...
            for c_idx, cell_value in enumerate(row):
                if c_idx < len(tr.cells):
                    ...
                    if is_header:
                        set_cell_background(cell, "1F4E78") # Deep Navy header
                    elif r_idx % 2 == 1:
...
if __name__ == "__main__":
    md_path = r"c:\Users\CP-1005\gravity\iast\iast\Appendices.md"
    docx_path1 = r"c:\Users\CP-1005\gravity\iast\iast\Appendices.docx"
    docx_path2 = r"c:\Users\CP-1005\gravity\iast\iast\Chapter_6_Appendices.docx"
    convert_md_to_docx(md_path, docx_path1)
    try:
        convert_md_to_docx(md_path, docx_path2)
    except PermissionError:
        print(f"Notice: {docx_path2} is currently locked by Word. Appendices.docx updated successfully.")
