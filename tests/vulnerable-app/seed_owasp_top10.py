"""Seeder script: Ingests all 10 OWASP Top 10 findings into the Aegis IAST Control Plane Database."""
...
async def main() -> None:
    ...
    async with container.unit_of_work() as uow:
        ...
        app_slug = Slug("owasp-vulnerable-app")
        app = await uow.applications.get_by_slug(app_slug)
        if not app:
            app = Application(
                id=uuid4(),
                organization_id=org_id,
                name="OWASP Top 10 Vulnerable Application",
                slug=app_slug,
        ...
        # 3. Resolve or create environment
    ...
    print("\n======================================================================")
    print("      INGESTED OWASP TOP 10 FINDINGS INTO CONTROL PLANE DATABASE")
    print("======================================================================")
    ...
    if res.rejections:
        print(f"Rejection Reasons : {res.rejections}")
